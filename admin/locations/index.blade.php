...
@section('content-header')
    <h1>Локации<small>Все локации, которым могут быть назначены узлы для упрощения категоризации.</small></h1>
    <ol class="breadcrumb">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="text-muted small">Короткий идентификатор, используемый для отличия этой локации от других. Должен быть от 1 до 60 символов, например, <code>us.nyc.lvl3</code>.</p>
                        </div>
                        <div class="col-md-12">
                            <label for="pLongModal" class="form-label">Описание</label>
                            <textarea name="long" id="pLongModal" class="form-control" rows="4"></textarea>
                            <p class="text-muted small">Длинное описание этой локации. Должно быть менее 191 символа.</p>
                        </div>
                    </div>
                </div>
